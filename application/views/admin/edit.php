        ...
        <div class="card-body ml-md-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h3 class="h5 text-gray-900 mt-sm-3 mb-sm-3">Keterangan Pribadi Arsip</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label col-form-label-sm" for="id_doc">
                                    Nomor Formulir
                                </label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control form-control-sm form-control form-control-sm" id="id_doc" name="id_doc" value="<?= $tbl_dokuments['id_doc']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="nama" placeholder="Masukkan Nama Lengkap" id="nama" class="form-control form-control-sm" value="<?= $tbl_dokuments['nama']; ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="tempat_lahir" placeholder="Tempat Lahir" id="tempat_lahir" class="form-control form-control-sm" value="<?= $tbl_dokuments['tempat_lahir']; ?>">
                                </div>
                                <div class="col-sm-3">
                                    <input type="date" name="tanggal_lahir" placeholder="Tanggal Lahir" id="tanggal_lahir" class="form-control form-control-sm" value="<?= $tbl_dokuments['tanggal_lahir']; ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    $pilih = $tbl_dokuments['jenis_kelamin'];
                                    echo form_dropdown(
                                        'jenis_kelamin',
                                        $jenis_kelamin,
                                        $pilih,
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    $pilih = $tbl_dokuments['warganegara'];;
                                    echo form_dropdown(
                                        'warganegara',
                                        $warganegara,
                                        $pilih,
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    $pilih = $tbl_dokuments['statussiswa'];
                                    echo form_dropdown(
                                        'statussiswa',
                                        $statussiswa,
                                        $pilih,
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" name="anak_ke" id="anak_ke" class="form-control form-control-sm" value="<?= $tbl_dokuments['anak_ke']; ?>">
                                </div>
                                <label class="col-sm-2 col-form-label col-form-label-sm" for="anak_ke">
                                    dari
                                </label>
                                <div class="col-sm-1">
                                    <input type="text" name="dari__bersaudara" id="dari__bersaudara" class="form-control form-control-sm" value="<?= $tbl_dokuments['dari__bersaudara']; ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" name="jumlah_saudara" id="jumlah_saudara" class="form-control form-control-sm" value="<?= $tbl_dokuments['jumlah_saudara']; ?>">
                                </div>
                            ...
                            <div class="form-group row mb-lg-5">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control form-control-sm form-control form-control-sm" id="email" name="email" placeholder="E-mail" value="<?= $tbl_dokuments['email']; ?>" readonly>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="row">
                                <img src="<?= base_url('assets/img/profile/') . $tbl_dokuments['image']; ?>" class="img-thumbnail mb-sm-3 p-sm-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input name="alamat" id="alamat" class="form-control form-control-sm" value="<?= $tbl_dokuments['alamat']; ?>"></input>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="rt" placeholder="RT" id="rt" class="form-control form-control-sm" value="<?= $tbl_dokuments['rt']; ?>">
                        </div>
                        <div class="col-sm-3">
                            <input type="text" name="rw" placeholder="RW" id="rw" class="form-control form-control-sm" value="<?= $tbl_dokuments['rw']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="kelurahan" placeholder="Kelurahan / Desa" id="kelurahan" class="form-control form-control-sm" value="<?= $tbl_dokuments['kelurahan']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="kecamatan" placeholder="Kecamatan" id="kecamatan" class="form-control form-control-sm" value="<?= $tbl_dokuments['kecamatan']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="no_hp" placeholder="Nomor HP" id="no_hp" class="form-control form-control-sm" value="<?= $tbl_dokuments['no_hp']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            $pilih = $tbl_dokuments['tinggalbersama'];;
                            echo form_dropdown(
                                'tinggalbersama',
                                $tinggalbersama,
                                $pilih,
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-1">
                            <input type="text" name="jarak" id="jarak" class="form-control form-control-sm" value="<?= $tbl_dokuments['jarak']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="asal_sekolah" placeholder="SMP/MTs" id="asal_sekolah" class="form-control form-control-sm" value="<?= $tbl_dokuments['asal_sekolah']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="nisn" placeholder="Nomor Induk Arsip Nasional (NISN)" id="nisn" class="form-control form-control-sm" value="<?= $tbl_dokuments['nisn']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="no_sttb" placeholder="Tanggal/Tahun/No.STTB" id="no_sttb" class="form-control form-control-sm" value="<?= $tbl_dokuments['no_sttb']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="pindahan" placeholder="Asal Sekolah" id="pindahan" class="form-control form-control-sm" value="<?= $tbl_dokuments['pindahan']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            $pilih = $tbl_dokuments['suratpindah'];
                            echo form_dropdown(
                                'suratpindah',
                                $suratpindah,
                                $pilih,
                    ...
                    <div class="form-group row mb-lg-5">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="alasan" placeholder="Alasan Pindah" id="alasan" class="form-control form-control-sm" value="<?= $tbl_dokuments['alasan']; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="nama_ot" placeholder="Masukkan Nama Orang Tua/Wali" id="nama_ot" class="form-control form-control-sm" value="<?= $tbl_dokuments['nama_ot']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input name="alamat_ot" id="alamat_ot" class="form-control form-control-sm" value="<?= $tbl_dokuments['alamat_ot']; ?>"></input>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="no_hp_ot" placeholder="Nomor HP" id="no_hp_ot" class="form-control form-control-sm" value="<?= $tbl_dokuments['no_hp_ot']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="pendidikan_ot" placeholder="Pendidikan Terakhir" id="pendidikan_ot" class="form-control form-control-sm" value="<?= $tbl_dokuments['pendidikan_ot']; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="pekerjaan_ot" placeholder="Pekerjaan" id="pekerjaan_ot" class="form-control form-control-sm" value="<?= $tbl_dokuments['pekerjaan_ot']; ?>">
                        </div>
